...
function renderHome() {
  ...
  const html = `
    <div class="intro">
      <h2>项目简介</h2>
      <p>本数据库是依托江苏省药品监督管理局药品监管科学科研计划项目“江苏道地药材重金属及有害元素风险评估和限量研究”构建的综合性数据平台。平台系统收录了苏薄荷、苏芡实、茅苍术、苏菊、白首乌、黄蜀葵花、银杏叶、白果、延胡索、女贞子、瓜蒌皮、天花粉、宜兴百合、浙贝母、金银花、蒲公英、泰半夏/邳半夏、蟾酥等江苏道地药材的重金属及有害元素检测数据，全面涵盖了铅、镉、砷、汞、铜等关键受控元素的含量信息。数据库整合了药材品种、产地、采样时间、元素含量等多维度信息，支持按品种、产地、元素类别等多角度交叉查询与对比分析。本该平台旨在为药品监管部门、中药材生产企业、科研机构及社会公众提供科学、可追溯的数据服务，助力江苏道地药材在全链条质量控制、风险精准预警及行业标准优化制定等方面的实践应用，切实保障用药安全，赋能并推动中医药产业向规范化和高品质方向持续发展。</p>
